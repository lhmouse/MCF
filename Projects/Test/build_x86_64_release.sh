...
LDFLAGS+=" -O3 -nostdlib -L../../release/mingw64/lib -lmcf -lsupc++ -lmcfcrt -lmingwex -lgcc -lgcc_s -lmcfcrt-pre-exe -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,-e@__MCFCRT_ExeStartup"
