...
extern void MCFBUILD_Sha256Simple(MCFBUILD_STD uint8_t (*MCFBUILD_RESTRICT pau8Result)[32], const void *MCFBUILD_RESTRICT pData, MCFBUILD_STD size_t uSize) MCFBUILD_NOEXCEPT;
