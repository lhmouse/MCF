...
extern std::jmp_buf *__MCF_CRT_abort_hool_jmpbuf;
...
bool __MCF_CRT_CallStaticCtors() noexcept {
	...
	int nResult;
	std::jmp_buf vJmpBuf;
	const auto pOldAbortHookBuf = ::__MCF_CRT_abort_hool_jmpbuf;
	::__MCF_CRT_abort_hool_jmpbuf = &vJmpBuf;
	...
	::__MCF_CRT_abort_hool_jmpbuf = pOldAbortHookBuf;
