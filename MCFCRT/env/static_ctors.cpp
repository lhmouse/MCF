...
extern std::jmp_buf *__MCFCRT_abort_hook_jmpbuf;
...
bool __MCFCRT_CallStaticCtors() noexcept {
	...
	int nResult;
	std::jmp_buf vJmpBuf;
	const auto pOldJmpBuf = ::__MCFCRT_abort_hook_jmpbuf;
	::__MCFCRT_abort_hook_jmpbuf = &vJmpBuf;
	...
	::__MCFCRT_abort_hook_jmpbuf = pOldJmpBuf;
