...
CPPFLAGS+=" -O3 -DNDEBUG -Wall -Wextra -pedantic -pedantic-errors -Wno-error=unused-parameter -Winvalid-pch	\
	...
	-pipe -mfpmath=both -march=core2 -mno-stack-arg-probe -masm=intel	\
...
LDFLAGS+=" -shared -O3 -nostdlib -L../../release/mingw32/lib -lmcf -lstdc++ -lmcfcrt -lmingwex -lgcc -lgcc_s -lmcfcrt-pre-dll -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,-e@__MCFCRT_DllStartup"
