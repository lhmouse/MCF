...
#	define __LDBL_DECL(name, ...)			long double name(__VA_ARGS__) __attribute__((alias("__MCF_CRTLdbl_" #name)));	\
										static __attribute__((cdecl)) long double *__MCF_CRTLdbl_##name(long double *_RetAddr, __VA_ARGS__)
