...
#ifndef MCF_UTILITIES_ALIGNED_UNION_HPP_
#define MCF_UTILITIES_ALIGNED_UNION_HPP_

#include <cstddef>

namespace MCF {

namespace Impl_AlignedUnion {
...
union AlignedUnion {
	alignas(Impl_AlignedUnion::MaxHelper<alignof(ElementsT)...>::kValue) char a[Impl_AlignedUnion::MaxHelper<kMinSizeT, sizeof(ElementsT)...>::kValue];
};
