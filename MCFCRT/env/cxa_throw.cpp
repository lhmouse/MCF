...
// hooks.h
void (*__MCFCRT_OnException)(void *pException, const std::type_info &tiType, const void *pRetAddr) = nullptr;
...
void __wrap___cxa_throw(void *pException, std::type_info *pTypeInfo, void (_GLIBCXX_CDTOR_CALLABI *pfnDtor)(void *)){
	if(__MCFCRT_OnException){
		(*__MCFCRT_OnException)(pException, *pTypeInfo, __builtin_return_address(0));
	}
