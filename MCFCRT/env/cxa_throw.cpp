...
// hooks.h
void (*__MCF_OnException)(void *pException, const std::type_info &tiType, const void *pRetAddr) = nullptr;
...
void __wrap___cxa_throw(void *pException, std::type_info *pTypeInfo, void (_GLIBCXX_CDTOR_CALLABI *pfnDtor)(void *)){
	if(__MCF_OnException){
		(*__MCF_OnException)(pException, *pTypeInfo, __builtin_return_address(0));
	}
