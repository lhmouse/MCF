...
LDFLAGS+=" -O3 -nostdlib -L../../release/mingw32/lib -DMCF_IMPORT_RTTI -lmcf -lsupc++ -lmcfcrt -lmingwex -lgcc -lgcc_eh -lmcfcrt-pre-exe -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,--disable-runtime-pseudo-reloc,-e@__MCFCRT_ExeStartup"
