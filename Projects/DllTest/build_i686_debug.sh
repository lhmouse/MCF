...
LDFLAGS+=" -shared -Og -g -nostdlib -L../../debug/mingw32/lib -DMCF_IMPORT_RTTI -lmcf -lsupc++ -lmingwex -lgcc -lmcfcrt-pre-dll -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,--disable-runtime-pseudo-reloc,-e@__MCFCRT_DllStartup"
