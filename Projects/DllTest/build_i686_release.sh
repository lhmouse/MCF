...
LDFLAGS+=" -shared -O3 -nostdlib -L../../release/mingw32/lib -lmcf -lsupc++ -lmcfcrt -lmingwex -lgcc -lgcc_s -lmcfcrt-pre-dll -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,-e@__MCFCRT_DllStartup"
