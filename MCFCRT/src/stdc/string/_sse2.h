...
__attribute__((__always_inline__)) static inline void __MCFCRT_xmmsetz(__m128i *__word) _MCFCRT_NOEXCEPT {
	*__word = _mm_setzero_si128();
}
__attribute__((__always_inline__)) static inline void __MCFCRT_xmmsetb(__m128i *__word, _MCFCRT_STD uint8_t __val) _MCFCRT_NOEXCEPT {
	*__word = _mm_set1_epi8((char)__val);
}
__attribute__((__always_inline__)) static inline void __MCFCRT_xmmsetw(__m128i *__word, _MCFCRT_STD uint16_t __val) _MCFCRT_NOEXCEPT {
	*__word = _mm_set1_epi16((short)__val);
}

__attribute__((__always_inline__)) static inline void __MCFCRT_xmmsetz_2(__m128i *__words) _MCFCRT_NOEXCEPT {
	__m128i *__wp = __words;
	for(unsigned __i = 0; __i < 2; ++__i){
		*(__wp++) = _mm_setzero_si128();
	}
}
__attribute__((__always_inline__)) static inline void __MCFCRT_xmmsetz_4(__m128i *__words) _MCFCRT_NOEXCEPT {
	__m128i *__wp = __words;
...
__attribute__((__always_inline__)) static inline _MCFCRT_STD uint32_t __MCFCRT_xmmcmp_21b(const __m128i *__lhs, const __m128i *__rhs) _MCFCRT_NOEXCEPT {
...
__attribute__((__always_inline__)) static inline _MCFCRT_STD uint32_t __MCFCRT_xmmcmp_41w(const __m128i *__lhs, const __m128i *__rhs) _MCFCRT_NOEXCEPT {
	_MCFCRT_STD uint32_t __mask = 0;
	for(unsigned __i = 0; __i < 2; ++__i){
...
__attribute__((__always_inline__)) static inline _MCFCRT_STD uint32_t __MCFCRT_xmmcmp_22b(const __m128i *__lhs, const __m128i *__rhs) _MCFCRT_NOEXCEPT {
	_MCFCRT_STD uint32_t __mask = 0;
	for(unsigned __i = 0; __i < 2; ++__i){
...
__attribute__((__always_inline__)) static inline _MCFCRT_STD uint32_t __MCFCRT_xmmcmp_44w(const __m128i *__lhs, const __m128i *__rhs) _MCFCRT_NOEXCEPT {
	_MCFCRT_STD uint32_t __mask = 0;
	for(unsigned __i = 0; __i < 2; ++__i){
...
__attribute__((__always_inline__)) static inline _MCFCRT_STD uint32_t __MCFCRT_xmmcmpor_211b(const __m128i *__lhs, const __m128i *__rhs, const __m128i *__third) _MCFCRT_NOEXCEPT {
	_MCFCRT_STD uint32_t __mask = 0;
	for(unsigned __i = 0; __i < 2; ++__i){
...
__attribute__((__always_inline__)) static inline _MCFCRT_STD uint32_t __MCFCRT_xmmcmpor_411w(const __m128i *__lhs, const __m128i *__rhs, const __m128i *__third) _MCFCRT_NOEXCEPT {
	_MCFCRT_STD uint32_t __mask = 0;
	for(unsigned __i = 0; __i < 2; ++__i){
...
__attribute__((__always_inline__)) static inline _MCFCRT_STD uint32_t __MCFCRT_xmmcmpandn_221b(const __m128i *__lhs, const __m128i *__rhs, const __m128i *__third) _MCFCRT_NOEXCEPT {
	_MCFCRT_STD uint32_t __mask = 0;
	for(unsigned __i = 0; __i < 2; ++__i){
...
__attribute__((__always_inline__)) static inline _MCFCRT_STD uint32_t __MCFCRT_xmmcmpandn_441w(const __m128i *__lhs, const __m128i *__rhs, const __m128i *__third) _MCFCRT_NOEXCEPT {
	_MCFCRT_STD uint32_t __mask = 0;
	for(unsigned __i = 0; __i < 2; ++__i){
