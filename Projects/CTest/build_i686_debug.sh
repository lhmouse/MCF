...
LDFLAGS+=" -Og -Wl,--gc-sections -nostdlib -L../../debug/mingw32/lib -DMCF_IMPORT_RTTI -lmcf -lmingwex -lgcc -lmcfcrt-pre-exe -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,--disable-runtime-pseudo-reloc,-e@__MCFCRT_ExeStartup"
