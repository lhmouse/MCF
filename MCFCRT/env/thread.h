...
extern void *MCF_CRT_CreateThread(unsigned (*__pfnThreadProc)(MCF_STD intptr_t), MCF_STD intptr_t __nParam, bool __bSuspended, MCF_STD uintptr_t *restrict __puThreadId) MCF_NOEXCEPT;
extern void MCF_CRT_CloseThread(void *__hThread) MCF_NOEXCEPT;

extern MCF_STD uintptr_t MCF_CRT_GetCurrentThreadId(void) MCF_NOEXCEPT;

extern void MCF_CRT_Sleep(MCF_STD uint64_t __u64UntilFastMonoClock) MCF_NOEXCEPT;
// 被 APC 打断返回 true，超时返回 false。
extern bool MCF_CRT_AlertableSleep(MCF_STD uint64_t __u64UntilFastMonoClock) MCF_NOEXCEPT;
extern void MCF_CRT_AlertableSleepInfinitely(void) MCF_NOEXCEPT;
extern void MCF_CRT_YieldThread(void) MCF_NOEXCEPT;
...
extern bool MCF_CRT_WaitForThread(void *__hThread, MCF_STD uint64_t __u64UntilFastMonoClock) MCF_NOEXCEPT;
