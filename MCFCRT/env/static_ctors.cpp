...
extern std::jmp_buf *__MCF_CRT_abort_hook_jmpbuf;
...
bool __MCF_CRT_CallStaticCtors() noexcept {
	...
	int nResult;
	std::jmp_buf vJmpBuf;
	const auto pOldJmpBuf = ::__MCF_CRT_abort_hook_jmpbuf;
	::__MCF_CRT_abort_hook_jmpbuf = &vJmpBuf;
	...
	::__MCF_CRT_abort_hook_jmpbuf = pOldJmpBuf;
