...
extern void MCF_CRT_Sleep(MCF_STD uint64_t __u64UntilUtcTime) MCF_NOEXCEPT;
// 被 APC 打断返回 true，超时返回 false。
extern bool MCF_CRT_AlertableSleep(MCF_STD uint64_t __u64UntilUtcTime) MCF_NOEXCEPT;
...
extern bool MCF_CRT_WaitForThread(void *__hThread, MCF_STD uint64_t __u64UntilUtcTime) MCF_NOEXCEPT;
