...
LDFLAGS+=" -Og -g -nostdlib -L../../debug/mingw32/lib -DMCF_IMPORT_RTTI -lmcf -lmingwex -lgcc -lgcc_eh -DMCF_IMPORT_RTTI -lmcfcrt-pre-exe -DMCF_IMPORT_RTTI -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,--disable-runtime-pseudo-reloc,-e@__MCFCRT_ExeStartup"
