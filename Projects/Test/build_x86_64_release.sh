...
LDFLAGS+=" -O3 -nostdlib -L../../release/mingw64/lib -DMCF_IMPORT_RTTI -lmcf -lsupc++ -lmingwex -lgcc -lgcc_eh -DMCF_IMPORT_RTTI -lmcfcrt-pre-exe -DMCF_IMPORT_RTTI -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,--disable-runtime-pseudo-reloc,-e@__MCFCRT_ExeStartup"
