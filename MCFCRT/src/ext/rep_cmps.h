...
#define __MCFCRT_REP_CMPS_DEFINE(__name_, __mnemonic_, __type_)	\
	...
	static inline int __name_(__type_ **_MCFCRT_RESTRICT __es1, __type_ **_MCFCRT_RESTRICT __es2, const __type_ *__s1, const __type_ *__s2, _MCFCRT_STD size_t __n) _MCFCRT_NOEXCEPT {	\
		bool __z, __b;	\
