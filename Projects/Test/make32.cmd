...
g++ %CXXFlags% -std=c++1y -Wall -Wextra -Wsuggest-attribute=noreturn -pipe -mfpmath=sse,387 -msse2 -masm=intel main.cpp -o ".%Config%.exe" -I../.. -L../../.Built/%Config% -static -nostartfiles -Wl,-e__MCF_ExeStartup,--disable-runtime-pseudo-reloc,--disable-auto-import,-lmcf,-lmcfcrt,-lstdc++,-lgcc,-lgcc_eh,-lmingwex,-lmcfcrt,-lws2_32,-lwinhttp,-lz || exit /b 1
