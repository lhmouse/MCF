...
LDFLAGS+=" -Og -g -nostdlib -L../../debug/mingw32/lib -static -lmcf -lsupc++ -lmingwex -lgcc -lgcc_eh -static -lmcfcrt-pre-exe -static -lmcfcrt -lmsvcrt -lkernel32 -lntdll -Wl,--disable-runtime-pseudo-reloc,-e@__MCFCRT_ExeStartup"
