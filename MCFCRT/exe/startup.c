...
static const char _tls_begin[0] = { };
...
static const DWORD _tls_index   = 0;

__attribute__((__section__(".CRT$@@@"), __used__))
static const PIMAGE_TLS_CALLBACK _tls_callback_begin = &TlsCallback;
__attribute__((__section__(".CRT$___"), __used__))
static const PIMAGE_TLS_CALLBACK _tls_callback_end   = nullptr;

__attribute__((__section__(".tls"), __used__))
const IMAGE_TLS_DIRECTORY _tls_used = {
	.StartAddressOfRawData = (UINT_PTR)&_tls_begin,
	.EndAddressOfRawData   = (UINT_PTR)&_tls_end,
	.AddressOfIndex        = (UINT_PTR)&_tls_index,
	.AddressOfCallBacks    = (UINT_PTR)&_tls_callback_begin,
	.SizeOfZeroFill        = 0,
	.Characteristics       = 0,
};
