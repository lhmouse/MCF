...
struct System {
	static void Print(MCF::WideStringView wsvText, bool bInsertsNewLine = true, bool bToStdErr = false) noexcept;
	static unsigned Shell(MCF::WideString &wcsStdOut, MCF::WideString &wcsStdErr, MCF::WideStringView wsvCommand);
