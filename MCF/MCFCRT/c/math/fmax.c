...
__MCF_CRT_EXTERN float fmaxf(float x, float y){
	register float ret;
	uintptr_t unused;
...
__MCF_CRT_EXTERN double fmax(double x, double y){
	register double ret;
	uintptr_t unused;
	__asm__ __volatile__(
#ifdef __amd64__
...
__MCF_CRT_EXTERN __LDBL_DECL(fmaxl, long double x, long double y){
